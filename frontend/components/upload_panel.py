...
def render_upload_panel() -> tuple[Any, dict, bool]:
    html_top = """
<div class="agent-card" style="padding: 3rem; max-width: 700px; margin: 4rem auto; text-align:center;">
    ...
    <div style="color:#00c8ff; font-weight:600; text-transform:uppercase; font-size:0.75rem; letter-spacing:0.1em; margin-bottom:0.5rem; text-align:left;">1. MRI Scan</div>
"""
    st.markdown(html_top, unsafe_allow_html=True)
    scan_file = st.file_uploader("Upload Scan", type=["nii", "gz", "png", "jpg", "jpeg"], label_visibility="collapsed")

    html_mid = """
<div style="color:#00c8ff; font-weight:600; text-transform:uppercase; font-size:0.75rem; letter-spacing:0.1em; margin-top:1.5rem; margin-bottom:0.5rem; text-align:left;">2. Patient Details</div>
"""
